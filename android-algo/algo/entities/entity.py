...
class CellState:
    ...
    def get_dict(self) -> dict[str, Union[int, str, None]]:
        """
        Returns a dictionary representation of the cell state
        """
...
class Obstacle(CellState):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        isinstance() ensures only compare Obstacle to another Obstacle
        """
...
class Grid:
    ...
    def reset_obstacles(self) -> None:
        ...
        This resets the internal obstacles list to empty, 
        allowing the grid to be reused without lingering state.
        """
