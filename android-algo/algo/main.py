...
motions, capture_labels, obstacle_ids = maze_solver.optimal_path_to_motion_path(optimal_path)
command_generator = CommandGenerator()
commands = command_generator.generate_commands(motions, capture_labels, obstacle_ids, optimal_path)
print(commands)
